...
<head>
  ...
  <title>MBOCWCESS Portal | Employers</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Employers</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>
                                        ...
                                        <a href='view-employer.php?id=".$row['id']."' class='btn btn-sm btn-info' ><i class='fas fa-eye'></i></a>
                                    </td>";
                                echo "</tr>";
                                $sr++;
                            }
                        } else {
                            echo "<tr><td colspan='9' class='text-center'>No Employer found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
