                                ...
                                <div class="work-order-section border p-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <a href="raise-invoice.php?id=<?= $wo['id'] ?>" class="btn btn-primary" <?= $remainingAmount < 0 ? 'disabled' : "" ?> <?= $remainingAmount < 0 ? 'onclick="return false;"' : '' ?>><i class="fas fa-eye"></i> Raise Invoice</a> 
                                            <a href="view-workorder-invoices.php?project_id=<?=$project_id?>&workorder_id=<?= $wo['id'] ?>" class="btn btn-warning ms-2"><i class="fas fa-edit"></i> View Invoice</a>
                                        </div>
                                        <div class="col-md-6">
