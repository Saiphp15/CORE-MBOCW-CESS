...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-2xl p-8 text-center border border-green-200">
        <div class="flex flex-col items-center">
            ...
            <a href="bulk-invoices-history.php" class="mt-6 w-full inline-block px-6 py-3 bg-green-500 text-white font-bold rounded-full transition duration-300 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
